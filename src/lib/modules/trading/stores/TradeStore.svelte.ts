...
import { TradePlanner, type PlannedTrade } from '$lib/modules/trading/domain/TradePlanner.js';
import { TradeExecutor } from '$lib/modules/trading/domain/TradeExecutor.js';
import { MarketMapper } from '$lib/modules/market/domain/MarketMapper.js';
import { bus } from '$lib/modules/core/events/globalBus.js'; // NEW: Event Bus
...
import { marketStore } from '../../market/stores/MarketStore.svelte.js';
