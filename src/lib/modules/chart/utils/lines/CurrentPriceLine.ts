import type { TradeCalculator } from '$lib/modules/trading/domain/TradeCalculator.js';
import type { LineTitleFormatter } from '$lib/modules/chart/utils/formatters/LineTitleFormatter.js';
