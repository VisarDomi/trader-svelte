...
import { isIOS } from "$lib/modules/core/utils/platform.js";
import { getTimeScaleHeight } from "$lib/modules/chart/utils/chartOptions.js";
import * as CHART_CONST from '$lib/shared/constants/chart.js';
import type { ViewportService } from "$lib/modules/core/services/ViewportService.svelte.js";
